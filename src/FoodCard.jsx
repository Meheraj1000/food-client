    ...
    <>
      <div className="card bg-base-100 shadow-xl flex flex-col">
        ...
        <div className="card-body">
          ...
          <div
            className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${statusStyles[foodStatus?.toLowerCase()] || 'bg-gray-100 text-gray-700'
              }`}
          >
            {foodStatus || 'Unknown Status'}
          </div>
